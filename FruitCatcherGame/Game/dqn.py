#This class defines the RL model and it's parameters using which we are planning to tackle the automation of the game.
import numpy as np
...
#This class defines which memory snippet of the game we acquire should be used for training the model
#Usually we go for choosing the memory snippet with the most error since the model can finetune according to the mistakes made
